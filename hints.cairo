...
func sqrt(n) -> (res):
    ...
    #It is important to check if the computation is performed correctly.
    #Change the assertion with n = res*res*res*res+1
    #and observe the program gives An ASSERT_EQ instruction failed error.
    return (res=res)
end
